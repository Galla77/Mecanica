...
SECRET_KEY = 'django-insecure-042t57&)^#i(*-siu+$^4$ix^ea0umx1a5rcv6-@-j)#^w0^h7'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = ['*'] # Allowed all for straightforward deployment initially, adjust based on Render URL in production.
